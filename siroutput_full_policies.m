function f = siroutput_full_policies(x,t)
...
A = [(1-k_infections) 0 k_recover 0;% each column must sum up to 1 which is why we do 1-k_rates
    (k_infections) (1-k_fatality-k_recover) 0 0;
    0 (k_recover) (1-k_recover) 0;
    0 (k_fatality) 0 1];
